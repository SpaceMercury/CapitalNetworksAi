...
def get_best_5_stocks():
    return ["AAPL", "MSFT", "TSLA", "ORACLE","CSCO"]
...
layout = [
    ...
    [sg.InputText(key='-CHATINPUT-', size=(170, 10), font=font_small), sg.Button('Send', size=(10, 1), font=font_medium, button_color=button_color, border_width=2)],
